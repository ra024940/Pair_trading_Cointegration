...
In summary, we created a list of model candidates by combining different sets of learning methods, dataset features and algorithm hyperparameters, all driven to address a binary classification problem which was, **Is this trade likely to be profitable?.**
